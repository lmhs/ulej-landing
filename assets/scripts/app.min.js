...
/***/ function(module, exports, __webpack_require__) {
	...
	// массив картинок
	var images = ['Main-01.jpg', 'Main-02.jpg', 'Main-03.jpg', 'Main-04.jpg', 'Main-05.jpg', 'Main-06.jpg', 'Main-07.jpg', 'Main-08.jpg', 'Main-09.jpg', 'Main-10.jpg', 'Main-11.jpg', 'Main-12.jpg', 'Main-13.jpg', 'Main-14.jpg'];
	
	// массив маленьких картинок
	var imagesSmall = ['Main-01-small.jpg', 'Main-02-small.jpg', 'Main-03-small.jpg', 'Main-04-small.jpg', 'Main-05-small.jpg', 'Main-06-small.jpg', 'Main-07-small.jpg', 'Main-08-small.jpg', 'Main-09-small.jpg', 'Main-10-small.jpg', 'Main-11-small.jpg', 'Main-12-small.jpg', 'Main-13-small.jpg', 'Main-14-small.jpg'];
	...
	(0, _jquery2['default'])(function () {
		...
		_jquery2['default'].validator.setDefaults({
			...
			errorPlacement: function errorPlacement(error, element) {
				(0, _jquery2['default'])(element).closest('.field-wrap').addClass('field--is-invalid');
			},
			highlight: function highlight(element, errorClass, validClass) {
				(0, _jquery2['default'])(element).closest('.field-wrap').addClass(errorClass);
			},
			unhighlight: function unhighlight(element, errorClass, validClass) {
				(0, _jquery2['default'])(element).closest('.field-wrap').removeClass(errorClass);
			},
			messages: {
				required: ''
			},
		...
		_jquery2['default'].validator.addMethod("phoneUS", function (phone_number, element) {
			phone_number = phone_number.replace(/\s+/g, "");
			return this.optional(element) || phone_number.length > 12 && phone_number.match(/(^\+375\s*\(?(15|16|17|21|22|23|25|29|33|44)\)?\s*[0-9]{3}(\s*|\-)[0-9]{2}(\s*|\-)[0-9]{2}$)/);
		}, "Please specify a valid phone number");
	
		// при сабмите формы открывается попап "спасибо, мы вам перезвоним"
		(0, _jquery2['default'])('#callback-form').validate({
		...
		(0, _jquery2['default'])('#send-form').validate({
			submitHandler: function submitHandler(form) {
				_jquery2['default'].magnificPopup.open({
					items: {
		...
		window.Utils = {
			magnificPopupConfiguration: function magnificPopupConfiguration() {
				var startWindowScroll = 0;
	
				return {
					beforeOpen: function beforeOpen() {
						startWindowScroll = (0, _jquery2['default'])(window).scrollTop();
						(0, _jquery2['default'])('html').addClass('mfp-helper');
						(0, _jquery2['default'])('.mfp-bg.mfp-ready').css('position', 'fixed');
					},
					close: function close() {
						(0, _jquery2['default'])('html').removeClass('mfp-helper');
						(0, _jquery2['default'])(window).scrollTop(startWindowScroll);
					}
				};
			}
		};
		...
		if (!Modernizr.input.placeholder) {
			(0, _jquery2['default'])('input[placeholder], textarea[placeholder]').placeholder();
		}
	
		var svgPos = (0, _jquery2['default'])('.js-change-svg-position');
		...
		(0, _jquery2['default'])(window).on('resize', function () {
			if ((0, _jquery2['default'])(window).width() < 720) {
				...
				(0, _jquery2['default'])('.clipping-bg').attr('transform', 'translate(350, 120)').attr('x', '50%').attr('y', '50%');
			} else {
				svgPos.attr('width', '1120').attr('height', '640').attr('transform', 'translate(-560, -320)').attr('x', '50%').attr('y', '50%');
				(0, _jquery2['default'])('.clipping-bg').attr('transform', 'translate(560, 320)').attr('x', '50%').attr('y', '50%');
			}
		});
	
		// открытие/закрытие секции с социальными кнопками
		var socialSection = (0, _jquery2['default'])('.js-toggle-social').closest('.js-social-section');
	
		(0, _jquery2['default'])('.js-toggle-social').on('click', function () {
			// repaint on safari
		...
		if ((0, _jquery2['default'])('.js-open-what-is').length) {
			(0, _jquery2['default'])('.js-open-what-is').magnificPopup({
				items: {
			...
			(0, _jquery2['default'])('.js-what-is-popup').on('click', '.js-close-message-popup', function () {
				_jquery2['default'].magnificPopup.close();
			});
		}
	
		// открытие попапа о проекте 1
		if ((0, _jquery2['default'])('.js-open-about-project-popup-1').length) {
			(0, _jquery2['default'])('.js-open-about-project-popup-1').magnificPopup({
				items: {
			...
			(0, _jquery2['default'])('.js-about-project-popup-1').on('click', '.js-close-message-popup', function () {
				_jquery2['default'].magnificPopup.close();
			});
		}
	
		// открытие попапа о проекте 2
		if ((0, _jquery2['default'])('.js-open-about-project-popup-2').length) {
			(0, _jquery2['default'])('.js-open-about-project-popup-2').magnificPopup({
				items: {
			...
			(0, _jquery2['default'])('.js-about-project-popup-2').on('click', '.js-close-message-popup', function () {
				_jquery2['default'].magnificPopup.close();
			});
		}
	
		// открытие попапа о проекте 3
		if ((0, _jquery2['default'])('.js-open-about-project-popup-3').length) {
			(0, _jquery2['default'])('.js-open-about-project-popup-3').magnificPopup({
				items: {
			...
			(0, _jquery2['default'])('.js-about-project-popup-3').on('click', '.js-close-message-popup', function () {
				_jquery2['default'].magnificPopup.close();
			});
		}
	
		// открытие попапа "перезвонить"
		if ((0, _jquery2['default'])('.js-open-callback').length) {
			(0, _jquery2['default'])('.js-open-callback').magnificPopup({
				items: {
		...
		if ((0, _jquery2['default'])('.js-callback-submit').length) {
			(0, _jquery2['default'])('.js-callback-message-popup').on('click', '.js-close-message-popup', function () {
				_jquery2['default'].magnificPopup.close();
			});
		}
	
		// открытие попапа "отправить информацию о проекте"
		if ((0, _jquery2['default'])('.js-open-send').length) {
			(0, _jquery2['default'])('.js-open-send').magnificPopup({
				items: {
					src: '.js-send-popup',
					preloader: false,
					type: 'inline',
		...
		if ((0, _jquery2['default'])('.js-send-submit').length) {
			(0, _jquery2['default'])('.js-send-message-popup').on('click', '.js-close-message-popup', function () {
				_jquery2['default'].magnificPopup.close();
			});
		}
	
		// наведение на ячейку с проектом — показывается ссылка с текстом и заливка градиентом
		(0, _jquery2['default'])('.js-project-tiles').on('mouseenter', '.js-tile a', function () {
			var tile = (0, _jquery2['default'])(this).closest('.js-tile');
		...
		(0, _jquery2['default'])('.js-project-tiles').on('mouseleave', '.js-tile a', function () {
			var tile = (0, _jquery2['default'])(this).closest('.js-tile');
...
/***/ function(module, exports) {
	...
	!(function (e, t, n) {
	  function r(e, t) {
	    ...
	    var e, t, n, i, o, a, s;for (var l in C) if (C.hasOwnProperty(l)) {
	    ...
	    if ("object" == typeof e) for (var n in e) k(e, n) && a(n, e[n]);else {
	    ...
	    var e = t.body;return e || (e = s(E ? "svg" : "body"), e.fake = !0), e;
	  }function f(e, n, r, i) {
	    var o,
	        a,
	        l,
	        ...
	        f = "modernizr",
	        d = s("div"),
	        p = c();if (parseInt(r, 10)) for (; r--;) l = s("div"), l.id = i ? i[r] : f + (r + 1), d.appendChild(l);return o = s("style"), o.type = "text/css", o.id = "s" + f, (p.fake ? p : d).appendChild(o), p.appendChild(d), o.styleSheet ? o.styleSheet.cssText = e : o.appendChild(t.createTextNode(e)), d.id = f, p.fake && (p.style.background = "", p.style.overflow = "hidden", u = x.style.overflow, x.style.overflow = "hidden", x.appendChild(p)), a = n(d, e), p.fake ? (p.parentNode.removeChild(p), x.style.overflow = u, x.offsetHeight) : d.parentNode.removeChild(d), !!a;
	  }function d(e, t) {
	    return function () {
	      return e.apply(t, arguments);
	    };
	  }function p(e, t, n) {
	    var i;for (var o in e) if (e[o] in t) return n === !1 ? e[o] : (i = t[e[o]], r(i, "function") ? d(i, n || t) : i);return !1;
	  }function m(e) {
	    ...
	    var i = t.length;if ("CSS" in e && "supports" in e.CSS) {
	      for (; i--;) if (e.CSS.supports(m(t[i]), r)) return !0;return !1;
	    }if ("CSSSupportsRule" in e) {
	      for (var o = []; i--;) o.push("(" + m(t[i]) + ":" + r + ")");return o = o.join(" or "), f("@supports (" + o + ") { #modernizr { position: absolute; } }", function (e) {
	    ...
	    }for (var f, d, p, m, g, v = ["modernizr", "tspan"]; !D.style;) f = !0, D.modElem = s(v.shift()), D.style = D.modElem.style;for (p = e.length, d = 0; p > d; d++) if ((m = e[d], g = D.style[m], l(m, "-") && (m = u(m)), D.style[m] !== n)) {
	      if (o || r(i, "undefined")) return a(), "pfx" == t ? m : !0;try {
	        D.style[m] = i;
	      } catch (y) {}if (D.style[m] != g) return a(), "pfx" == t ? m : !0;
	    }return a(), !1;
	  }function v(e, t, n, i, o) {
	    var a = e.charAt(0).toUpperCase() + e.slice(1),
	        s = (e + " " + O.join(a + " ") + a).split(" ");return r(t, "string") || r(t, "undefined") ? g(s, t, i, o) : (s = (e + " " + T.join(a + " ") + a).split(" "), p(s, t, n));
	  }function y(e, t, r) {
	    return v(e, n, n, t, r);
	  }var b = [],
	      C = [],
	      S = { _version: "3.2.0", _config: { classPrefix: "", enableClasses: !0, enableJSClass: !0, usePrefixes: !0 }, _q: [], on: function on(e, t) {
	      ...
	      Modernizr = function Modernizr() {};Modernizr.prototype = S, Modernizr = new Modernizr(), Modernizr.addTest("svg", !!t.createElementNS && !!t.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect);var w = S._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : [];S._prefixes = w;var x = t.documentElement,
	      E = "svg" === x.nodeName.toLowerCase();E || !(function (e, t) {
	    function n(e, t) {
	      ...
	      if ((e || (e = t), f)) return e.createDocumentFragment();n = n || o(e);for (var i = n.frag.cloneNode(), a = 0, s = r(), l = s.length; l > a; a++) i.createElement(s[a]);return i;
	    }function l(e, t) {
	      ...
	      e || (e = t);var r = o(e);return !b.shivCSS || c || r.hasCSS || (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), f || l(e, r), e;
	    }var c,
	        f,
	        d = "3.7.3",
	        p = e.html5 || {},
	    ...
	    })();var b = { elements: p.elements || "abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output picture progress section summary template time video", version: d, shivCSS: p.shivCSS !== !1, supportsUnknownElements: f, shivMethods: p.shivMethods !== !1, type: "default", shivDocument: u, createElement: a, createDocumentFragment: s, addElements: i };e.html5 = b, u(t), "object" == typeof module && module.exports && (module.exports = b);
	  })("undefined" != typeof e ? e : this, t);var _ = "Moz O ms Webkit",
	      T = S._config.usePrefixes ? _.toLowerCase().split(" ") : [];S._domPrefixes = T;var k;!(function () {
	  ...
	  }), Modernizr.addTest("placeholder", "placeholder" in s("input") && "placeholder" in s("textarea"));var N = s("input"),
	  ...
	  })(P);var A = "search tel url email datetime date month week time datetime-local number range color".split(" "),
	      j = {};Modernizr.inputtypes = (function (e) {
	    for (var r, i, o, a = e.length, s = "1)", l = 0; a > l; l++) N.setAttribute("type", r = e[l]), o = "text" !== N.type && "style" in N, o && (N.value = s, N.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(r) && N.style.WebkitAppearance !== n ? (x.appendChild(N), i = t.defaultView, o = i.getComputedStyle && "textfield" !== i.getComputedStyle(N, null).WebkitAppearance && 0 !== N.offsetHeight, x.removeChild(N)) : /^(search|tel)$/.test(r) || (o = /^(url|email)$/.test(r) ? N.checkValidity && N.checkValidity() === !1 : N.value != s)), j[e[l]] = !!o;return j;
	  })(A);var L = (function () {
	    function e(e, t) {
	      var i;return e ? (t && "string" != typeof t || (t = s(t || "div")), e = "on" + e, i = e in t, !i && r && (t.setAttribute || (t = s("div")), t.setAttribute(e, ""), i = "function" == typeof t[e], t[e] !== n && (t[e] = n), t.removeAttribute(e)), i) : !1;
	    }var r = !("onblur" in t.documentElement);return e;
	  })();S.hasEvent = L, Modernizr.addTest("inputsearchevent", L("search"));var F = "CSS" in e && "supports" in e.CSS,
	      M = ("supportsCSS" in e);Modernizr.addTest("supports", F || M);var H = ({}).toString;Modernizr.addTest("smil", function () {
	    return !!t.createElementNS && /SVGAnimate/.test(H.call(t.createElementNS("http://www.w3.org/2000/svg", "animate")));
	  });var O = S._config.usePrefixes ? _.split(" ") : [];S._cssomPrefixes = O, Modernizr.addTest("svgclippaths", function () {
	    return !!t.createElementNS && /SVGClipPath/.test(H.call(t.createElementNS("http://www.w3.org/2000/svg", "clipPath")));
	  });var V = S.testStyles = f;Modernizr.addTest("details", function () {
	    var e,
	        t = s("details");return "open" in t ? (V("#modernizr details{display:block}", function (n) {
	    ...
	    var r,
	      ...
	      var s = w[a],
	          l = s.toUpperCase() + "_" + r;if (l in o) return "@-" + s.toLowerCase() + "-" + t;
	    }return !1;
	  };S.atRule = q;var B = { elem: s("modernizr") };Modernizr._q.push(function () {
	    delete B.elem;
	  });var D = { style: B.elem.style };Modernizr._q.unshift(function () {
	    delete D.style;
	  });S.testProp = function (e, t, r) {
	    return g([e], n, t, r);
	  };S.testAllProps = v, S.testAllProps = y, Modernizr.addTest("cssanimations", y("animationName", "a", !0)), Modernizr.addTest("flexbox", y("flexBasis", "1px", !0)), Modernizr.addTest("csstransforms", function () {
	    return -1 === navigator.userAgent.indexOf("Android 2.") && y("transform", "scale(1)", !0);
	  }), Modernizr.addTest("csstransforms3d", function () {
	    var e = !!y("perspective", "1px", !0),
	        t = Modernizr._config.usePrefixes;if (e && (!t || "webkitPerspective" in x.style)) {
	      var n,
	          r = "#modernizr{width:0;height:0}";Modernizr.supports ? n = "@supports (perspective: 1px)" : (n = "@media (transform-3d)", t && (n += ",(-webkit-transform-3d)")), n += "{#modernizr{width:7px;height:18px;margin:0;padding:0;border:0}}", V(r + n, function (t) {
	        e = 7 === t.offsetWidth && 18 === t.offsetHeight;
	      });
	    }return e;
	  });var $ = S.prefixed = function (e, t, n) {
	    return 0 === e.indexOf("@") ? q(e) : (-1 != e.indexOf("-") && (e = u(e)), t ? v(e, t, n) : v(e, "pfx"));
	  };Modernizr.addTest("backgroundblendmode", $("backgroundBlendMode", "text")), i(), o(b), delete S.addTest, delete S.addAsyncTest;for (var R = 0; R < Modernizr._q.length; R++) Modernizr._q[R]();e.Modernizr = Modernizr;
	})(window, document);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;// http://kenwheeler.github.io/slick/
	'use strict';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! Magnific Popup - v1.0.1 - 2015-12-30
